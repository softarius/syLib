...
begin
  ...
  begin
    Close;
    SelectSQL.Text := format('select * from %s order by 1', [fdsDicListNAME.Value]);

    AutoUpdateOptions.UpdateTableName := fdsDicListNAME.Value;
    Open;
    ...
    sql := format
      ...
      ' and RDB$CONSTRAINT_TYPE = ''PRIMARY KEY'')', [fdsDicListNAME.Value]);
