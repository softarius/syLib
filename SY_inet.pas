...
/// <summary>
///  опирует содержимое, возвращаемое из Resource с сервера Server в строку
/// </summary>
function GetUrlContent(Server, Resource: string): widestring;
var
...
{ TUpdaterSY }
/// <summary>
/// ѕровер€ет наличие новой версии
/// <param name="SupressEqualMessage">ѕодавл€ть выдачу сообщени€ о том, что номера версий равны</param>
/// </summary>
